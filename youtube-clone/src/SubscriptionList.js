...
const baseURL = "https://flash-api.herokuapp.com/feed/subscriptionlist/{channelId}";

function SubscriptionListVideos() {
  ...
  return (
    <div className="subscriptionListVideos">
      <h2>Subscription List Videos</h2>
      <div className="subscriptionlist_videos">
...
export default SubscriptionListVideos