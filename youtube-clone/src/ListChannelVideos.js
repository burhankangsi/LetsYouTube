...
import "./ChannelListVideos.css";
import VideoCard from './VideoCard';
import axios from 'axios';

const baseURL = "https://flash-api.herokuapp.com/{channelId}/videos";
...
function ChannelListVideos() {
  ...
  return (
    <div className="channelListVideos">
      <h2>Channel List Videos</h2>
      <div className="channellist_videos">
...
export default ChannelListVideos